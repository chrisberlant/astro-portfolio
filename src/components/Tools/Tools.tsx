    ...
    return (
        <section className="flex flex-col items-center">
            ...
            <div className="flex w-full max-w-7xl flex-col gap-8">
                <Card className="justify-evenly gap-4 pb-4 lg:flex-row lg:pb-0 lg:pl-0 lg:pr-4">
                    <OrbitingCirclesTools />
                    <div className="flex-1">
                        <h2 className="font-montserrat mb-8 text-center text-3xl font-bold sm:mb-12">
                            Dev environment
                        </h2>
                        <ul className="flex flex-col flex-wrap items-center gap-2 text-center lg:items-start lg:text-left xl:pr-5">
                            <li>
                ...
                <Card className="flex-1 justify-evenly pb-4 md:gap-4 lg:flex-row-reverse">
                    <img
                        src={OperatingSystemAnimate}
                        alt=""
                        className="max-w-60 flex-1 md:max-w-xs lg:pr-4 xl:max-w-md"
                    />
                    <div className="mt-8 flex-1 text-center lg:mt-10 xl:mt-0">
                        <h2 className="font-montserrat mb-8 text-3xl font-bold sm:mb-10">
                            Online tools
                        </h2>
                        <ul className="flex flex-col flex-wrap items-center gap-2.5 lg:items-start lg:pl-5 lg:text-left">
                            <li>
                                <a
                                    className="font-bold"
                            ...
                            <li>
                                ...
                                >
                                    <img
                                        ...
                                        className="ml-2 mr-1.5 inline-block size-5"
                                        alt="GitHub logo"
                                    />
                                    GitHub
                                </a>{" "}
                            ...
                            <li>
                                ...
                                >
                                    <img
                                        ...
                                        className="ml-2 mr-1 inline-block size-5"
                                        alt="Vercel logo"
                                    />
                                    Vercel
                                </a>{" "}
                                ...
                                >
                                    <img
                                        src={NetlifyLogo}
                                        className="mx-2 inline-block size-5"
                                        alt="Netlify logo"
                                    />
                                    Netlify
                                </a>{" "}
                ...
                <Card className="justify-evenly pb-4 md:gap-4 lg:flex-row">
                    <img
                        src={BuildingAnimate}
                        alt=""
                        className="max-w-60 flex-1 pt-1 md:max-w-xs lg:pl-4 lg:pt-0 xl:max-w-md"
                    />
                    <div className="mt-8 flex flex-1 flex-col items-center">
                        <h2 className="font-montserrat mb-8 text-center text-3xl font-bold sm:mb-10">
                            Libraries
                        </h2>
                        ...
                        <ul className="mt-2 flex max-h-48 list-disc flex-col flex-wrap gap-2">
                            <li>
                                <a
                                    className="font-bold"
                ...
                <Card className="justify-evenly pb-4 md:gap-4 lg:flex-row-reverse">
                    <img
                        src={BookmarksAnimate}
                        alt=""
                        className="max-w-60 flex-1 pt-2 md:max-w-xs lg:pr-4 lg:pt-0 xl:max-w-md"
                    />
                    <div className="mt-8 flex flex-1 flex-col items-center">
                        <h2 className="font-montserrat mb-8 text-center text-3xl font-bold sm:mb-10">
                            Bookmarks
