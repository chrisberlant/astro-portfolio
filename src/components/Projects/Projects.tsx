...
import ProjectCard, { type ProjectType } from "./ProjectCard/ProjectCard";
...
const gestionSmac: ProjectType = {
  ...
  description: {
    ...
    content: (
      <div>
        <p>
          This internal webapp allows a team to manage a stock of various mobile
          devices (basic phones, smartphones, 4G modems).
        </p>
        <p>
          It includes authentication, creating/reading/updating/deleting
          multiple elements, and CSV files import/export.
        </p>
        <p>
          An admin dashboard allows users with the required role to do things
          like see the actions history and create new users allowed to access
          the app.
        </p>
...
const jobMemo: ProjectType = {
  ...
  description: {
    ...
    content: (
      <div>
        <p>
          Help users track their various job applications and their associated
          contacts.
        </p>
        <p>
          It includes authentication, creating/reading/updating/deleting job
          offers and contacts.
        </p>
        <p>The main feature is the cards drag and drop.</p>
        <p>
          A trash bin allows the user to drag cards inside and restore them
          later if needed, or delete them permanently, just like on a desktop
          environment.
        </p>
      </div>
    ),
